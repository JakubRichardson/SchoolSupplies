...
//
//JLabel titleLabel = new JLabel("Borrow");
//titleLabel.setHorizontalAlignment(SwingConstants.CENTER);
//titleLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
//titleLabel.setBounds(200, 31, 266, 38);
...
//panel.add(btnBack);
//
//JButton btnSubmit = new JButton("Borrow");
//btnSubmit.setFont(new Font("Tahoma", Font.PLAIN, 14));
//btnSubmit.setBounds(397, 377, 132, 49);
//panel.add(btnSubmit);
//
...
//panel.add(lblMonth);
//
//JLabel lblYearBorrow = new JLabel("Year");
...
//panel.add(lblYearBorrow);
//
//JLabel lblDateToday = new JLabel("Date Today:");
//lblDateToday.setHorizontalAlignment(SwingConstants.LEFT);
//lblDateToday.setFont(new Font("Tahoma", Font.PLAIN, 14));
//lblDateToday.setBounds(20, 383, 367, 43);
//panel.add(lblDateToday);
//
//JLabel msgLabel = new JLabel("");
//msgLabel.setHorizontalAlignment(SwingConstants.CENTER);
//msgLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
//msgLabel.setBounds(10, 31, 229, 43);
//panel.add(msgLabel);
//
//lblQuantityAvailable = new JLabel("Quantity Available");
//lblQuantityAvailable.setHorizontalAlignment(SwingConstants.CENTER);
//lblQuantityAvailable.setFont(new Font("Tahoma", Font.PLAIN, 14));
//lblQuantityAvailable.setBounds(10, 137, 151, 43);
//panel.add(lblQuantityAvailable);
//
//lblBorrowQuantity = new JLabel("Borrow Quantity");
//lblBorrowQuantity.setHorizontalAlignment(SwingConstants.CENTER);
//lblBorrowQuantity.setFont(new Font("Tahoma", Font.PLAIN, 14));
//lblBorrowQuantity.setBounds(332, 137, 151, 43);
//panel.add(lblBorrowQuantity);
//
//spinner = new JSpinner();
//spinner.setModel(new SpinnerNumberModel(new Integer(1), null, null, new Integer(1)));
//spinner.setBounds(493, 137, 153, 43);
//panel.add(spinner);
//
//lblQuantityAvailable_2 = new JLabel("12");
//lblQuantityAvailable_2.setHorizontalAlignment(SwingConstants.CENTER);
//lblQuantityAvailable_2.setFont(new Font("Tahoma", Font.PLAIN, 14));
//lblQuantityAvailable_2.setBounds(171, 137, 151, 43);
//panel.add(lblQuantityAvailable_2);
